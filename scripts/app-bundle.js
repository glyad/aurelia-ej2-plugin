...
;
define('__dot_dot__/src/elements/base/events',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function fireEventWithCustomInit(element, name, eventInitDict) {
        var event = new CustomEvent(name, eventInitDict);
        element.dispatchEvent(event);
        return event;
    }
    exports.fireEventWithCustomInit = fireEventWithCustomInit;
});
;
...
define('main',["require", "exports", "aurelia-pal", "./environment"], function (require, exports, aurelia_pal_1, environment_1) {
    ...
    function configure(aurelia) {
        aurelia.use
            ...
            .feature('resources')
            .plugin(aurelia_pal_1.PLATFORM.moduleName('elements'));

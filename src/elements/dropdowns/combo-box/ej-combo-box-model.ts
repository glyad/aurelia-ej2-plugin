...
import { ComboBox, ComboBoxModel, CustomValueSpecifierEventArgs } from "@syncfusion/ej2-dropdowns"
import { EjDropDownListModel } from './../drop-down-list/ej-drop-down-list-model';

export class EjComboBoxModel<T> extends EjDropDownListModel<ComboBox> implements ComboBoxModel {

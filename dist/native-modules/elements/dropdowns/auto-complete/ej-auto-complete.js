...
import { customElement, bindable, inlineView, autoinject, TargetInstruction, TaskQueue, bindingMode, processContent } from 'aurelia-framework';
...
var EjAutoComplete = (function (_super) {
    ...
    EjAutoComplete = __decorate([
        ...
        __metadata("design:paramtypes", [Element, TaskQueue, TargetInstruction])
    ], EjAutoComplete);
